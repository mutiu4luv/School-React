  ...
  return (
    <div className="section" id="teacher">
      <div className="grid sm:grid-cols-2 place-items-center gap-8">
        <div className="pl-5">
          <div className="font-bold sm:text-[1.875rem] text-[1.5rem] mb-5 text-center text-red-500">
      ...
      <div className="text-center my-8 font-bold sm:text-[1.875rem] text-[1.5rem]    text-center text-red-500  ">
